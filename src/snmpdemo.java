...
public class snmpdemo {
    ...
    public void sendMessage(Boolean syn, PDU pdu, String addr)
            throws IOException {
        // 生成目标地址对象
        ...
        if (syn) {
            ...
            // 处理响应
            System.out.println("Synchronize(同步) message from "
    ...
    public static void main(String[] args) throws IOException {
        ...
        snmpdemo manager = new snmpdemo(ver2c);
        // 构造报文
        PDU pdu = new PDU();
        ...
        try {
           ...
           // manager.sendMessage(false, true, pdu, "udp:192.168.1.229/161");//192.168.1.229 Linux服务器
            manager.sendMessage(true, pdu, "udp:127.0.0.1/161");//192.168.1.233 WinServer2008服务器
        } catch (IOException e) {
            e.printStackTrace();
        }
